  ...
  if (req.method === 'POST') {
    ...
    await sql(
       `INSERT INTO quotations (id, number, payment_type, date, valid_until, client_name, client_document, client_email, client_address,
        ...
        quantity, immediate_deposit, total, initial_payment, installments, monthly_payment, valid_until_time,
        advisor_name, advisor_document, advisor_phone, advisor_email, advisor_address, created_at)
       ...
       ON CONFLICT (id) DO UPDATE SET
        ...
        quantity=$27, immediate_deposit=$28, total=$29, initial_payment=$30, installments=$31, monthly_payment=$32, valid_until_time=$33,
        advisor_name=$34, advisor_document=$35, advisor_phone=$36, advisor_email=$37, advisor_address=$38`,
      [
        ...
        d.quantity, d.immediateDeposit ?? 0, d.total, d.initialPayment ?? 0, d.installments ?? 0, d.monthlyPayment ?? 0, d.validUntilTime ?? '',
        d.advisorName, d.advisorDocument, d.advisorPhone, d.advisorEmail, d.advisorAddress, d.createdAt,
      ]
    );
...
function toQuotation(r: Record<string, unknown>) {
  return {
    ...
    immediateDeposit: Number(r.immediate_deposit ?? 0),
    ...
    validUntilTime: r.valid_until_time ?? '',
